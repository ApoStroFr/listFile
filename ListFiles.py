...
### ROUTINE 1
root1='D:\\Loisir\\Python' 	### /!\ NE PAS OUBLIER DE METTRE 2 ANTISLASH POUR QUE PYTHON INTERPETRE UN SEUL ANTISLASH DANS LE PATH
row=routine(root1, ws, row)
root2='D:\\Loisir\\Python'	### /!\ NE PAS OUBLIER DE METTRE 2 ANTISLASH POUR QUE PYTHON INTERPETRE UN SEUL ANTISLASH DANS LE PATH
